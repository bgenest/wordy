...
guess2 = Guess.create(user: user1, session: session1, guess:"beans")
guess3 = Guess.create(user: user1, session: session1, guess:"Banana")
...
guess5 = Guess.create(user: user2, session: session2, guess:"horses")
guess6 = Guess.create(user: user2, session: session2, guess:"keypad")
guess7 = Guess.create(user: user2, session: session2, guess:"bottle")
guess8 = Guess.create(user: user2, session: session2, guess:"apples")
...
guess13 = Guess.create(user: user3, session: session3, guess:"unsure")
